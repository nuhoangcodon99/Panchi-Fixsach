...
public class Manager {
    ...
    public static final String queryTopSM = "SELECT id, CAST(SUBSTRING_INDEX(data_point, ',', -14) AS UNSIGNED) AS sm FROM player ORDER BY sm DESC LIMIT 20;";
    ...
    public static final String queryTopThachDau = "SELECT id, CAST( thachdauwhis AS UNSIGNED) AS thachdauwhis FROM player ORDER BY CAST( thachdauwhis AS UNSIGNED) DESC LIMIT 20";
    ...
    public static List<TOP> TopThachDau;
...
//                RUBY_REWARDS.add(Util.sendDo(861, 0, new ArrayList<>()));
            ...
            TopThachDau = realTop(queryTopThachDau, con);
            Logger.success("Load top Thách Đấu Whis thành công (" + TopThachDau.size() + ")\n");
            ...
            while (rs.next()) {
                ...
                switch (query) {
                    ...
                    case queryTopLeoThap:
                        ...
                        break;
                    case queryTopThachDau:
                        top.setInfo1(rs.getInt("thachdauwhis") + " tầng");
                        top.setInfo2(rs.getInt("thachdauwhis") + " tầng");
                        break;
                    case queryTopCauCa:
