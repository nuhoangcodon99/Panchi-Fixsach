...
public class DataGame {
    ...
    public static String LINK_IP_PORT = "NRO LOCAL:127.0.0.1:14445:0,0,0";
    private static final String MOUNT_NUM = "733:1,734:2,735:3,743:4,744:5,746:6,795:7,849:8,897:9,920:10,1143:11,1141:15,1337:17,1338:18,1339:19,1340:20,1341:21,1342:22,1343:23,1344:24,1415:25,1416:26,1537:27,1538:28,1539:29,1540:30,1541:31,1549:32,1550:33"; // Thêm thú cưỡi
            ...
            for (NClass nClass : Manager.NCLASS) {
                ...
                for (SkillTemplate skillTemp : nClass.skillTemplatess) {
                    ...
                    if (skillTemp.id != 0) {
                        ...
                        msg.writer().writeByte(skillTemp.skillss.size() + 3);
                        for (Skill skill : skillTemp.skillss) {
                            msg.writer().writeShort(skill.skillId);
                            msg.writer().writeByte(skill.point);
                            msg.writer().writeLong(skill.powRequire);
