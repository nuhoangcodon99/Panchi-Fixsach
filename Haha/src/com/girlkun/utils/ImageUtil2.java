...
public class ImageUtil2 {
    ...
    try {
        ...
        // In thông số đọc được từ dữ liệu
        System.out.println("Thông số đọc được cho mob " + mob + ":");
        System.out.println("Zoom Level: " + zoomlv);
        System.out.println("Loại đọc: " + typeRead);
        System.out.println("Độ dài dữ liệu: " + data.length);
        System.out.println("Độ dài dữ liệu hình ảnh: " + dataImage.length);
    ...
    try {
        ...
        for (int i = 0; i < nImageInfo; i++) {
            ...
            try {
                ...
                System.out.println("Lỗi đọc thông tin hình ảnh cho mob: " + mobId);
            }
            
            // In thông số hình ảnh mỗi bộ phận đọc được
            System.out.println("Thông số hình ảnh bộ phận " + id + " cho mob " + mobId + ":");
