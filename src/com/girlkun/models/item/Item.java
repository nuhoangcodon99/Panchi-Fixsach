...
public class Item {
    ...
    public boolean isCTGoHanSSJ() {

        if (this.template.id == 1192) {
            return true;
        }
    ...
    public boolean isCTBaby() {

        if (this.template.id == 1216) {
            return true;
        }
    ...
    public boolean isCTBlackGoku() {

        if (this.template.id == 1280) {
            return true;
        }
    ...
    public boolean isCTBill() {

        if (this.template.id == 2008) {
            return true;
        }
