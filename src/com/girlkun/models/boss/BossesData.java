...
public class BossesData {
    ...
    public static final BossData SO_2 = new BossData(
            ...
            new int[][]{
                {Skill.LIEN_HOAN, 7, 1000},
                {Skill.ANTOMIC, 7, 5000},},//skill//skill
            new String[]{}, //text chat 1
            new String[]{"|-1|Oải rồi hả?", "|-1|Ê cố lên nhóc",
                "|-1|Chán", "|-1|Đại ca Fide có nhầm không nhỉ",
                "|-1|Một mình tao chấp hết tụi bây",
...
//---------------------BOSS MAI SU  PILAF -------------------------------    
    public static final BossData MAI = new BossData(
            ...
            new String[]{"|-1|Người thật yếu đuối"}, //text chat 1
            new String[]{"|-1|Ta sẽ cho ngươi thấy đâu mới là sức mạnh tối thượng"}, //text chat 2
            new String[]{"|-1|Hãy gọi đồng bọn đi"}, //text chat 3
            REST_10_M
    );
    ...
    public static final BossData BOSS_MA_VUONG_PICOLO = new BossData(
            "Ma Vương Picolo",
            ConstPlayer.XAYDA,
            new short[]{633, 634, 635, -1, -1, -1},
            80000,
            new long[]{1_500_000_000L},
            new int[]{181},
            new int[][]{
                {Skill.KAMEJOKO, 7, 5000},
            ...
            new String[]{"|-2|Tái tạo, tái tạo nào..."}, // text chat 1
            new String[]{"|-1|Nghe danh Ma Vương Picolo chưa?"}, // text chat 2
            new String[]{"|-1|Ngươi định giết ta ư ...."}, // text chat 3
            REST_30_M
    );

    public static final BossData BOSS_BANG_TINH = new BossData(
            "Nhật Thần",
            ConstPlayer.XAYDA,
            new short[]{1261, 1262, 1263, -1, -1, -1},
            80000,
            new long[]{750_000_000L},
            new int[]{180},
            new int[][]{
                {Skill.KAMEJOKO, 7, 5000},
                {Skill.KHIEN_NANG_LUONG, 3, 180000},
                {Skill.LIEN_HOAN, 7, 500},
                {Skill.THAI_DUONG_HA_SAN, 7, 40000},
                {Skill.QUA_CAU_KENH_KHI, 2, 100000},
                {Skill.THOI_MIEN, 7, 30000}
            },
            new String[]{"|-2|Tái tạo, tái tạo nào..."}, // text chat 1
            new String[]{"|-1|Nghe danh Ma Vương Picolo chưa?"}, // text chat 2
    ...
    public static final BossData BOSS_HOA_TINH = new BossData(
            "Nguyệt Thần",
            ConstPlayer.XAYDA,
    ...
    public static final BossData BOSS_MA_BU_COM = new BossData(
            "MaBư Còm",
            ConstPlayer.XAYDA,
            new short[]{427, 428, 429, -1, -1, -1},
            80000,
            new long[]{1_500_000_000L},
            new int[]{105, 106, 107, 108, 109, 110},
            new int[][]{
                {Skill.KAMEJOKO, 7, 5000},
                //                    { Skill.KHIEN_NANG_LUONG, 7, 180000 },
                {Skill.LIEN_HOAN, 7, 500},
            ...
            new String[]{"|-2|Tái tạo, tái tạo nào..."}, // text chat 1
            new String[]{"|-1|Nghe danh MaBư chưa?"}, // text chat 2
            new String[]{"|-1|Ngươi định giết ta ư ...."}, // text chat 3
            REST_30_M
    );

    public static final BossData BOSS_MA_BU_MAP = new BossData(
            "MaBư Mập",
            ConstPlayer.XAYDA,
            new short[]{297, 298, 299, -1, -1, -1},
            80000,
            ...
            new String[]{"|-2|Xí hụt, Xí hụt..."}, // text chat 1
            new String[]{""}, // text chat 2
            new String[]{"|-1|Hãy xem ta né đây...."}, // text chat 3
            REST_30_M
    );

    public static final BossData BOSS_MA_BU_DEP_TRAI = new BossData(
            "MaBư Đẹp Trai",
            ConstPlayer.XAYDA,
    ...
    public static final BossData BOSS_KHI_ULTRA = new BossData(
            "Khỉ Đột",
            ConstPlayer.XAYDA,
            new short[]{200, 193, 194, -1, -1, -1},
            100000,
            ...
            new String[]{"|-2|Ta sẽ nuốt chửng ngươi!"}, // text chat 1
            new String[]{"|-1|21h đến 23h rồi, ta sẽ cho ngươi thấy sức mạnh của ta"}, // text chat 2
            new String[]{"|-1|Trăng tròn... Ngươi không thoát được đâu"}, // text chat 3
            REST_30_M
    );

    public static final BossData BOSS_THO_DAI_KA = new BossData(
            "Đại ca Thỏ Ngọc",
            ConstPlayer.XAYDA,
            ...
            new int[][]{
                {Skill.LIEN_HOAN, 7, 10000},
                {Skill.THAI_DUONG_HA_SAN, 7, 60000},},
            new String[]{"|-2|Ngươi muốn cướp cà rốt của ta ư ..."}, // text chat 1
            new String[]{"|-1|Ta sẽ cho ngươi thấy sức mạnh của ta"}, // text chat 2
            new String[]{"|-1|Hãy đợi đấy ta sẽ trở lại"}, // text chat 3
            REST_5_M
    );

    public static final BossData BOSS_THAN_MEO = new BossData(
            "Thần Mèo",
            ConstPlayer.XAYDA,
            ...
            new String[]{"|-2|Muốn tăng sức mạnh thì hãy giết ta đi!!"}, // text chat 1
            new String[]{"|-1|20h đến 22h rồi, ta sẽ cho ngươi thấy sức mạnh của ta"}, // text chat 2
            new String[]{"|-1|Bay bay ngươi đã mạnh hơn hãy gặp ta vào lần sau"}, // text chat 3
            REST_30_M
    );
    ...
    public static final BossData RUONG_12 = BossData.builder()
            ...
            .outfit(new short[]{1231, 1232, 1233, -1, -1, -1})
            .mapJoin(new int[]{129})
            .skillTemp(new int[][]{
