    ...
    public void chat(Player player, String text) {
        ...
        if (player.getSession() != null && player.isAdmin()) {
            ...
            if (text.equals("admin")) {
                NpcService.gI().createMenuConMeo(player, ConstNpc.MENU_ADMIN, 20673, "|7| ADMIN \n •⊹٭Ngọc Rồng SenKai٭⊹•\b|2| •⊹٭♥Bùi Kim Trường♥٭⊹•\b|4| Người Đang Chơi: " + Client.gI().getPlayers().size() + "\n" + "|8|Current thread: " + (Thread.activeCount() - ServerManager.gI().threadMap)
...
//        }
        ...
        if (text.equals("player")) {
            NpcService.gI().createMenuConMeo(player, ConstNpc.CLCK, 20673, "|7|Dragon Ball SenKai\n" + "\n"
    ...
    public void point(Player player) {
        ...
        if (!player.isPet && !player.isBoss && !player.isNewPet) {
            ...
            try {
                ...
                msg.writer().writeByte(Util.TamkjllGH(player.nPoint.speed));// speed
    ...
    public void player(Player pl) {
        ...
        try {
            ...
            msg.writer().writeShort(20673); //char info id
...
//            Send_Info_NV(pl);
    ...
    public void sendThongBaoFromAdmin(Player player, String text) {
        sendBigMessage(player, 20673, text);
    }
